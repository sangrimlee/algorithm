import { addTwoPromises } from './leetcode-2723';

describe('2023-06-12: LeetCode 2723', () => {
  test('Example 1', async () => {
    ...
    expect(await addTwoPromises(promise1, promise2)).toEqual(7);
  });
  test('Example 2', async () => {
    ...
    expect(await addTwoPromises(promise1, promise2)).toEqual(-2);
  });
});
