import { compareTree, createTree } from '../../lib/create-tree';
import { pruneTree } from './leetcode-814';

describe('2022-09-06: LeetCode 814', () => {
  test('Example 1', () => {
    const root = createTree([1, 0, null, 0, 1]);
    const answer = createTree([1, 0, null, null, 1]);
  ...
  test('Example 2', () => {
    ...
    const answer = createTree([1, null, 1, null, null, null, 1]);
